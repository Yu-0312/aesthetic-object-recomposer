...
> Use the supplied approved Kawaii Clean image as an immutable base. Preserve every photographic pixel and all existing character faces, limbs, props, and symbols. Add only the planned storytelling layer: [CAPTION 1] near [ANCHOR 1], [CAPTION 2] near [ANCHOR 2], and optionally [CAPTION 3] near [ANCHOR 3]. Use lively hand-drawn sticker lettering with varied scale and rotation, thick contrasting outlines, 2–4 scene-derived accent colors, compact speech bubbles, curved arrows, sparkles, music notes, and comic emphasis marks. When the story benefits, attach 1–2 small hand-drawn props such as a chef hat, spoon, flag, headband, instrument, menu, or alarm clock to an existing character; keep prop coverage below 10% and match the existing doodle line work. Create an asymmetric hierarchy with one large hero phrase, one smaller reaction, and optional tiny sound or mood marks. Keep each Chinese caption to 4–12 characters or each English caption to 1–5 words. Place text only in calm negative space; never cover food texture, product labels, faces, hands, controls, or hero silhouettes. Keep total text coverage below 16% of the frame. Render all requested text exactly as supplied. No new photographed objects, new characters, changed expressions, moved doodles, dense paragraphs, fake labels, watermark, social-media UI, composition grid, or tutorial diagram.
