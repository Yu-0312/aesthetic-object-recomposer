...
> Use the supplied approved Kawaii Clean image as an immutable base. Preserve every photographic pixel and all existing character faces, limbs, props, and symbols. Add only the planned storytelling layer: [CAPTION 1] near [ANCHOR 1], [CAPTION 2] near [ANCHOR 2], and optionally [CAPTION 3] near [ANCHOR 3]. Use lively hand-drawn lettering with varied scale, subtle speech bubbles, curved arrows, sparkles, music notes, and emotion marks. Prefer blush, sweat drops, question marks, surprise rays, sleepy symbols, hearts, or tiny motion trails. Only when the story benefits, place 1–2 airy outline-style mini illustrations beside the character or in adjacent negative space; use at most two small color fills sampled from the photo, keep new illustration coverage around 3–6% and below 8%, and never paste a large prop across the subject. Create an asymmetric hierarchy with one hero phrase, one smaller reaction, and optional tiny sound marks. Keep each Chinese caption to 4–12 characters or each English caption to 1–5 words. Place text only in calm negative space; never cover food texture, product labels, faces, hands, controls, or hero silhouettes. Keep total text coverage below 16% of the frame. Render all requested text exactly as supplied. No new photographed objects, new characters, changed expressions, moved doodles, oversized hats or utensils, dense paragraphs, fake labels, watermark, social-media UI, composition grid, or tutorial diagram.
